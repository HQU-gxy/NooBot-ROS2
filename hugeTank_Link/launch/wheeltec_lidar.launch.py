...
def generate_launch_description():
    ...
    scan_dir = get_package_share_directory('pointcloud_to_laserscan')
    scan_launch_dir = os.path.join(scan_dir, 'launch')
    ...
    point_to_scan = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(scan_launch_dir, 'pointcloud_to_laserscan_launch.py')),)
