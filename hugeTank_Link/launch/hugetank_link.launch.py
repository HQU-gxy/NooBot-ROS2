...
def generate_launch_description():
    ...
    ekf_config = Path(get_package_share_directory('hugetank_link'), 'config', 'ekf.yaml')
    ekf_carto_config = Path(get_package_share_directory('hugetank_link'), 'config', 'ekf_carto.yaml')

    imu_config = Path(get_package_share_directory('hugetank_link'), 'config', 'imu.yaml')
    ...
    tank_model = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(launch_dir, 'model_description.launch.py')),
